...
Future<void> generateAndPrintArabicPdf(
    InvoiceData? data, ContactData contact, String dataId) async {
  final pw.Document pdf = pw.Document();

  final balance = contact.balance! - (data?.total ?? 0);
        ...
        return pw.Center(
          ...
          pw.Row(mainAxisAlignment: pw.MainAxisAlignment.end, children: [
            pw.Directionality(
                textDirection: pw.TextDirection.rtl,
                child: pw.Center(
                    child: pw.Text('${contact.firstName} ${contact.lastName}',
                        style: pw.TextStyle(
                          fontSize: 13,
                        )))),
            pw.Directionality(
          ...
          pw.Row(mainAxisAlignment: pw.MainAxisAlignment.end, children: [
            pw.Directionality(
                textDirection: pw.TextDirection.rtl,
                child: pw.Center(
                    child: pw.Text(contact.username.toString(),
                        style: pw.TextStyle(
                          fontSize: 13,
                        )))),
            pw.Directionality(
